...
import { Archive, Link as LinkIcon, ExternalLink, MessageSquare, Plus, X, AlignLeft, Tag, Send, Trash2 } from 'lucide-react'
import Editor from '@/components/ui/Editor'
import { createArchive, createComment, deleteArchive } from '@/lib/sheets'
          ...
          <div className="max-w-3xl mx-auto animate-in fade-in duration-300">
            <div className="flex justify-between items-start mb-6">
                ...
                {(currentUser?.이름 === selectedDoc.작성자 || isAdmin) && (
                    <button onClick={handleDelete} className="p-2 text-slate-400 hover:text-red-500 transition-colors" title="문서 삭제"><Trash2 size={20}/></button>
                )}
            </div>
